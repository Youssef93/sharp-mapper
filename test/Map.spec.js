...
describe('MapService', () => {  
  ...
  describe('structureMap', () => {
    ...
    it('should test arrayWithinArray-to-arrayWithinArray mapping with filtering', () => {
      const data = require('./testData/arrayWithinArray-to-arrayWithinArrayWithFilter/data');
      const mappingSchema = require('./testData/arrayWithinArray-to-arrayWithinArrayWithFilter/mappingSchema');
      const validation = require('./testData/arrayWithinArray-to-arrayWithinArrayWithFilter/validation');
      const mappedObject = MapService.structureMap(data, mappingSchema);
      expect(mappedObject).to.deep.equal(validation);
    ...
    it('should test arrayWithinArray-to-arrayWithinArray mapping with find', () => {
      const data = require('./testData/arrayWithinArray-to-arrayWithinArrayWithFind/data');
      const mappingSchema = require('./testData/arrayWithinArray-to-arrayWithinArrayWithFind/mappingSchema');
      const validation = require('./testData/arrayWithinArray-to-arrayWithinArrayWithFind/validation');
      const mappedObject = MapService.structureMap(data, mappingSchema);
      expect(mappedObject).to.deep.equal(validation);
    ...
    it('should test array of objects to array of primitive values mapping with filtering', () => {
      const data = require('./testData/array-of-objects-to-array-of-primitivewithfilter/data');
      const mappingSchema = require('./testData/array-of-objects-to-array-of-primitivewithfilter/mappingSchema');
      const validation = require('./testData/array-of-objects-to-array-of-primitivewithfilter/validation');
      const mappedObject = MapService.structureMap(data, mappingSchema);
      expect(mappedObject).to.deep.equal(validation);
    ...
    it('should test array of objects to array of primitive values mapping with find', () => {
      const data = require('./testData/array-of-objects-to-array-of-primitivewithfind/data');
      const mappingSchema = require('./testData/array-of-objects-to-array-of-primitivewithfind/mappingSchema');
      const validation = require('./testData/array-of-objects-to-array-of-primitivewithfind/validation');
      const mappedObject = MapService.structureMap(data, mappingSchema);
      expect(mappedObject).to.deep.equal(validation);
